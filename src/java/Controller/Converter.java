...
public class Converter {
    ...
    public static String bintookt(String binary) {
        int decimal = bintoint(binary);
        return inttookt(decimal);
    }

    public static String bintohexa(String binary) {
        int decimal = bintoint(binary);
        return inttohexa(decimal);
    }

    public static String okttohexa(String octal) {
        int decimal = okttoint(octal);
        return inttohexa(decimal);
    }

    public static String okttobin(String octal) {
        int decimal = okttoint(octal);
        return inttobiner(decimal);
    }

    public static String hexatookt(String hex) {
        int decimal = hexatoint(hex);
        return inttookt(decimal);
    }
